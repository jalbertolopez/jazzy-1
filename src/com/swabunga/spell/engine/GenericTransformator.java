...
public class GenericTransformator implements Transformator {
	...
	// Inner Classes
	/*
	 * Holds the match string and the replace string and all the rule attributes. Is
	 * responsible for indicating matches.
	 */
	private class TransformationRule {
		...
		// Construktor
		public TransformationRule(String match, String replace, int takeout, int matchLength, boolean start,
				boolean end) {
		...
		public String toString() {
			return "Match:" + String.valueOf(match) + " Replace:" + replace + " TakeOut:" + takeOut + " MatchLength:"
					+ matchLength + " Start:" + start + " End:" + end;
		}
