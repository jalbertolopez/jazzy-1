...
public class SpellDictionary {
	...
	private static final char[] replacelist = { 'A', 'B', 'X', 'S', 'K', 'J', 'T', 'F', 'H', 'L', 'M', 'N', 'P', 'R',
			'0' };
	 ...
	 * doublemeta code. The map entry contains a LinkedList of words that have the
	 * same double meta code.
	 */
	 ...
	 * <p>
	 * This is a very slow function. On my machine it takes quite a while to load
	 * the data in. I suspect that we could speed this up quite alot.
	 */
