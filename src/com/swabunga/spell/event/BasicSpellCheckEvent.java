...
class BasicSpellCheckEvent implements SpellCheckEvent {
	 ...
	 * @param List
	 *            suggestions A list of Word objects that are suggested to replace
	 *            the currently mispelt word
	 * @param WordTokenizer
	 *            tokenizer The reference to the tokenizer that caused this event to
	 *            fire.
	 */
	...
	/**
	 * Set the action to add a new word into the dictionary. This will also replace
