...
/**
 * This class spellchecks a JTextComponent throwing up a Dialog everytime it
 * encounters a misspelled word.
 *
...
public class JTextComponentSpellChecker implements SpellCheckListener {
	...
	public JTextComponentSpellChecker(String dictFile, String phoneticFile, String title) throws IOException {
		this(new SpellDictionary(new File(dictFile), new File(phoneticFile)), title);
	}
